        ...
        <div class="glass-card p-6 rounded-lg space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="text" name="menu_section" value="{{ old('menu_section', $product->menu_section ?? '') }}" class="input-dark">
                </div>
                <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                    <label class="block text-sm font-medium text-slate-400 mb-1">Sold out until</label>

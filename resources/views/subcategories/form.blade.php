...
<div class="max-w-2xl mx-auto">
    <form method="POST" action="{{ isset($subcategory) ? route('admin.subcategories.update', $subcategory->id) : route('admin.subcategories.store') }}">
        ...
        <div class="glass-card p-6 rounded-lg space-y-4">
            ...
            <div>
                <label class="block text-sm font-medium text-slate-400 mb-2">Recommended Business Modules</label>
                <p class="text-xs text-slate-500 mb-3">These are suggestions for vendors. Explore and contact remain available for every business.</p>

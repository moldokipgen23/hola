    ...
    <div class="flex h-screen relative z-10">
        ...
        <aside class="sidebar w-64 flex flex-col mobile-menu" id="sidebar">
            ...
            <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
                ...
                <a href="{{ route('vendor.services') }}" class="sidebar-link {{ request()->routeIs('vendor.services*') ? 'active' : '' }}">
                ...
                <a href="{{ route('vendor.bookings') }}" class="sidebar-link {{ request()->routeIs('vendor.bookings*') ? 'active' : '' }}">
                ...
                <p class="text-[11px] font-semibold text-slate-600 uppercase tracking-wider px-4 mb-2 mt-6">Engagement</p>
                <a href="{{ route('vendor.reviews') }}" class="sidebar-link {{ request()->routeIs('vendor.reviews*') ? 'active' : '' }}">

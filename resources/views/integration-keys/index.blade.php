    ...
    <div class="glass-card p-6 rounded-lg">
        <div class="flex items-center justify-between mb-6">
            <div>
                ...
                <p class="text-slate-400 text-xs mt-1">Keys used by external services (Hola, AI Agent, ERP systems) to connect to your data.</p>
            </div>
        ...
        <form id="createForm" method="POST" action="{{ route('admin.integration-keys.generate') }}" class="hidden mb-6 p-4 bg-white/5 rounded-lg space-y-3">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                <div>
                    ...
                    <input type="text" name="name" required placeholder="e.g. Hola Directory" class="input-dark text-sm w-full">
                </div>
                <div>
